...
gork = Enemy('Бехир', kd[0], hp[0], strength[0], dexterity[0], att[0], add_damage[0], add_hit[0])
mork = Enemy('Дао', kd[1], hp[1], strength[1], dexterity[1], att[1], add_damage[1], add_hit[1])
